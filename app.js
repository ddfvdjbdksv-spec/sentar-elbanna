...
/**
 * سنتر البنا v2.0 - Core Intelligence Engine
 */
...
function applyProgramProfile() {
    ...
    const centerDisplay = profile.centerName || 'سنتر البنا';
...
const exposures = {
    ...
    prepareHandoverDownload: async () => {
        ...
        const dataJsContent = `/**
 * سنتر البنا Data Storage File - للبيع والنقل
